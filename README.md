...
- `/api/daily-goals` are the three daily completion-gated goals
...
- `/api/recipes` are the saved recipes
- `/api/yume/categories`, `/api/yume/items` is the bucket-list board
